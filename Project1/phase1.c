...
//calculates all money deposited
...
// deposit puts money into account, withdrawl takes it out
...
//time(null) returns current time in secs
//pthread_self retunrs thread ID
